  ...
  <div class="h-screen flex w-full bg-img" id="page-login">
    <div class="vx-col sm:w-1/3 m-auto self-center login-page">
      ...
      <div class="vx-col w-full">
        <h1 align="center" class="my-4">{{ $t('labels.gmsIq') }}</h1>
        <div class="vx-row justify-center flex">
          <div class="vx-col w-full">
            ...
            <div class="login-footer md:flex my-6" align="center">
              <a class="md:pr-6">{{ $t('labels.privacy') }}</a>
              <a class="md:pl-6">{{ $t('labels.terms') }}</a>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  destroyed() {
    this.$store.commit('clearPasswordField',null,{module:'login'});
  }
};
</script>
<style scoped>
